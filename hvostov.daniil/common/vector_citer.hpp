...
template <class T> topit::CIterator<T>::CIterator() : ptr_(nullptr) {}

template <class T> topit::CIterator<T>::CIterator(T *ptr) : ptr_(ptr) {}

template <class T>
topit::CIterator<T>::CIterator(const CIterator<T> &it) : ptr_(it.ptr_) {}

template <class T>
topit::CIterator<T>::CIterator(CIterator<T> &&it) noexcept : ptr_(it.ptr_) {
  it.ptr_ = nullptr;
}
...
template <class T>
topit::CIterator<T> &
topit::CIterator<T>::operator=(CIterator<T> &&it) noexcept {
  if (this != &it) {
    ptr_ = it.ptr_;
    it.ptr_ = nullptr;
  }
...
template <class T> const T &topit::CIterator<T>::operator*() const {
  return *ptr_;
}
...
template <class T> topit::CIterator<T> &topit::CIterator<T>::operator++() {
  ++ptr_;
  return *this;
}

template <class T> topit::CIterator<T> topit::CIterator<T>::operator++(int) {
